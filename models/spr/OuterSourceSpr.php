 ...
 */
class OuterSourceSpr extends \yii\db\ActiveRecord
{
    use SoftDeleteTrait;
    /**
     * {@inheritdoc}
...
//    }
    ...
    public static function findByParams($search = null, $trashed_button = null, $node_type = null)
    {
        $query = (new Query())
            ->select('
            redevs_spr.id,
            ...
            redevs_spr.deleted_at')->andWhere(['redevs_spr.node_type' => 'X'])
            ->from('redevs_spr');
