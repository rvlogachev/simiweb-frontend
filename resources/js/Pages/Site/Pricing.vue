<template>
  <main class="sj">
    ...
    <!-- Pricing Tables -->
    <section class="am ax aq">
      <div class="sc tj fv vs">
        <div class="li ls gs go">

          <!-- Section header -->
          <div class="sh tj ce ls">
            <h1 class="h1 nw" data-aos="zoom-y-out">Start for free. Pay as you grow. Switch at any time.</h1>
            <p class="cr c_" data-aos="zoom-y-out" data-aos-delay="150">No matter how many team members you have - our pricing is simple, transparent and adapts to the size of your company.</p>
          </div>
          ...
          <div x-data="pricingSwitch">
            ...
            <!-- Pricing toggle -->
            <div class="ii us sp tw rh" data-aos="zoom-y-out" data-aos-delay="300">
              <div class="j ii ij no ff bg-gray-200 uy">
                                    <span class="_ z t_ w" aria-hidden="true">
                                        <span class="_ z sf bg-white uy shadow om hq pn po" :class="value ? 'translate-x-0' : 'translate-x-full'"></span>
                                    </span>
                <button class="j sx cn cc ff hq pn po" :class="{'text-gray-500':!value}" @click.prevent="value = true">Bill Yearly <span class="hl">-20%</span>
                </button>
                <button class="j sx cn cc ff hq pn po" :class="{'text-gray-500':value}" @click.prevent="value = false">Bill Monthly</button>
              </div>
            </div>

            <div class="sg ma yh tj io uu mv yp yd ut">

              <!-- Pricing table 1 -->
              <div class="j ii oz ib f_ fj uy bg-white hx" data-aos="zoom-y-out" data-aos-delay="450">
                <div class="nw">
                  <div class="ci ch re">Starter</div>
                  <div class="is ur nk">
                    <span x-text="priceOutput.plan1[value][0]" class="ca ch"></span>
                    <span x-text="priceOutput.plan1[value][1]" class="cf ch"></span>
                    <span x-text="priceOutput.plan1[value][2]" class="c_ lg"></span>
                  </div>
                  <div class="ci he">For larger teams that need to create, and collaborate.</div>
                </div>
                <ul class="c_ rg sj">
                  <li class="ii un nk">
                    <svg class="iz il ft hl rs s_" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="uq border-gray-200 ly ro">
                  <a class="r cz au pl ij" href="pricing.html#0">Try for free</a>
                </div>
              </div>

              <!-- Pricing table 2 -->
              <div class="j ii oz ib f_ fj uy al hx uj ai" data-aos="zoom-y-out" data-aos-delay="450">
                <div class="_ ta tt ry fl rb ah ub">
                  <svg class="ss iv ft cz" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15.145 5.05l-4.316-.627L8.898.513c-.338-.684-1.456-.684-1.794 0l-1.93 3.91-4.317.627a1.002 1.002 0 00-.554 1.707l3.124 3.044-.737 4.3a1 1 0 001.45 1.053L8 13.125l3.862 2.03c.728.381 1.59-.234 1.45-1.054l-.736-4.299L15.7 6.758a1.003 1.003 0 00-.555-1.708z"></path>
                  </svg>
                </div>
                <div class="nw">
                  <div class="ci ch re">Agency</div>
                  <div class="is ur nk">
                    <span x-text="priceOutput.plan2[value][0]" class="ca ch"></span>
                    <span x-text="priceOutput.plan2[value][1]" class="cf ch"></span>
                    <span x-text="priceOutput.plan2[value][2]" class="c_ lg"></span>
                  </div>
                  <div class="ci he">For larger teams that need to create, and collaborate.</div>
                </div>
                <ul class="c_ rg sj">
                ...
                <div class="uq border-gray-200 ly ro">
                  <a class="r cz au pl ij" href="pricing.html#0">Start free trial</a>
                </div>
              </div>
              ...
              <div class="j ii oz ib f_ fj uy bg-white hx" data-aos="zoom-y-out" data-aos-delay="450">
                <div class="nw">
                  <div class="ci ch re">Premium</div>
                  <div class="is ur nk">
                    <span x-text="priceOutput.plan3[value][0]" class="ca ch"></span>
                    <span x-text="priceOutput.plan3[value][1]" class="cf ch"></span>
                    <span x-text="priceOutput.plan3[value][2]" class="c_ lg"></span>
                  </div>
                  <div class="ci he">For larger teams that need to create, and collaborate.</div>
                </div>
                <ul class="c_ rg sj">
              ...
              <div class="j ii oz ib f_ fj uy bg-white hx" data-aos="zoom-y-out" data-aos-delay="450">
                <div class="nw">
                  <div class="ci ch re">Enterprise</div>
                  <div class="is ur nk">
                    <span x-text="priceOutput.plan4[value][0]" class="ca ch"></span>
                    <span x-text="priceOutput.plan4[value][1]" class="cf ch"></span>
                    <span x-text="priceOutput.plan4[value][2]" class="c_ lg"></span>
                  </div>
                  <div class="ci he">For larger teams that need to create, and collaborate.</div>
                </div>
                <ul class="c_ rg sj">
    ...
    <section>
      <div class="sc tj fv vs">
        <div class="lm ga">
          ...
          <!-- Table -->
          <div class="ug">
            <table class="sq ij uz border-gray-200">
              <!-- Table header -->
              <thead>
              <tr class="cs vf uq border-gray-200">
                <th class="text-bold lz lb fg sl">Breakdown of features</th>
                <th class="text-bold ce fq fg">Starter</th>
                <th class="text-bold ce fq fg">Premium</th>
                <th class="text-bold ce fq fg">Agency</th>
                <th class="text-bold ce lg fg">Enterprise</th>
              </tr>
              </thead>
              <!-- Table body -->
              <tbody>
              <!-- Row -->
              <tr class="uq border-gray-200">
                <td class="cn vl lb fg">
                  <div class="cc hd">Unlimited viewers</div>
                  <div class="c_">Lorem ipsum dolor sit amet, consectetur adipiscing elit</div>
                </td>
                <td class="cn fq fg ce cc">
                  <svg class="iz il ft hl is" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z"></path>
                  </svg>
                </td>
                <td class="cn fq fg ce cc">
              ...
              <tr class="uq border-gray-200">
                <td class="cn vl lb fg">
                  <div class="cc hd">Team members</div>
                  <div class="c_">Excepteur sint occaecat cupidatat non proident</div>
                </td>
                <td class="cn fq fg ce cc">3</td>
                <td class="cn fq fg ce cc">Unlimited</td>
                <td class="cn fq fg ce cc">Unlimited</td>
                <td class="cn lg fg ce cc">Unlimited</td>
              </tr>
              <!-- Row -->
              <tr class="uq border-gray-200">
                <td class="cn vl lb fg">
                  <div class="cc hd">Projects</div>
                  <div class="c_">Culpa qui officia deserunt mollit anim</div>
                </td>
                <td class="cn fq fg ce cc">3</td>
                <td class="cn fq fg ce cc">20</td>
                <td class="cn fq fg ce cc">50</td>
                <td class="cn lg fg ce cc">Unlimited</td>
              </tr>
              <!-- Row -->
              <tr class="uq border-gray-200">
                <td class="cn vl lb fg">
                  <div class="cc hd">Dedicated support</div>
                  <div class="c_">Excepteur sint occaecat cupidatat non proident</div>
                </td>
                <td class="cn fq fg ce cc">
                  <svg class="iz il ft hl is" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
              ...
              <tr class="uq border-gray-200">
                <td class="cn vl lb fg">
                  <div class="cc hd">Private projects</div>
                  <div class="c_">Lorem ipsum dolor sit amet, consectetur adipiscing elit</div>
                </td>
                <td class="cn fq fg ce cc">
                  <svg class="iz il ft cj hb is" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10.72 1.293a1 1 0 00-1.415 0L6.012 4.586 2.72 1.293a1 1 0 00-1.414 1.414L4.598 6 1.305 9.293a1 1 0 101.414 1.414l3.293-3.293 3.293 3.293a1 1 0 001.414-1.414L7.426 6l3.293-3.293a1 1 0 000-1.414z"></path>
                  </svg>
                </td>
                <td class="cn fq fg ce cc">
                  <svg class="iz il ft hl is" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
              ...
              <tr class="uq border-gray-200">
                <td class="cn vl lb fg">
                  <div class="cc hd">Public repositories</div>
                  <div class="c_">Ut enim ad minim veniam quis nostrud exercitation ullamco</div>
                </td>
                <td class="cn fq fg ce cc">
                  <svg class="iz il ft cj hb is" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10.72 1.293a1 1 0 00-1.415 0L6.012 4.586 2.72 1.293a1 1 0 00-1.414 1.414L4.598 6 1.305 9.293a1 1 0 101.414 1.414l3.293-3.293 3.293 3.293a1 1 0 001.414-1.414L7.426 6l3.293-3.293a1 1 0 000-1.414z"></path>
              ...
              <tr class="uq border-gray-200">
                <td class="cn vl lb fg">
                  <div class="cc hd">Account manager</div>
                  <div class="c_">Condimentum id venenatis a condimentum vitae</div>
                </td>
                <td class="cn fq fg ce cc">
                  <svg class="iz il ft cj hb is" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10.72 1.293a1 1 0 00-1.415 0L6.012 4.586 2.72 1.293a1 1 0 00-1.414 1.414L4.598 6 1.305 9.293a1 1 0 101.414 1.414l3.293-3.293 3.293 3.293a1 1 0 001.414-1.414L7.426 6l3.293-3.293a1 1 0 000-1.414z"></path>
    ...
    <section class="j">
      ...
      <div class="_ tr om or ti rr w" aria-hidden="true">
      ...
      <div class="sc tj fv vs">
        <div class="fy gn">
          ...
          <div class="sh tj ce ls gu">
            <h2 class="h2 nw">Trusted by over 20,000 companies all over the world</h2>
            <p class="cr c_">Arcu cursus vitae congue mauris rhoncus viverra nibh cras pulvinar mattis
              blandit libero cursus mattis.</p>
          </div>

          <!-- Items -->
          <div class="sg ml tj io ul o_ my">

            <!-- Item -->
            <div class="ii un us fp tv vv">
              <svg class="sm ft cj" width="124" height="24" viewBox="0 0 124 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Item -->
            <div class="ii un us fp tv vv">
              <svg class="sm ft cj" width="83" height="30" viewBox="0 0 83 30" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Item -->
            <div class="ii un us fp tv vv">
              <svg class="sm ft cj" width="125" height="39" viewBox="0 0 125 39" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Item -->
            <div class="ii un us fp tv vv">
              <svg class="sm ft cj" width="113" height="30" viewBox="0 0 113 30" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Item -->
            <div class="ii un us fp tv vv tm tg">
              <svg class="sm ft cj" width="109" height="33" viewBox="0 0 109 33" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="sh tj">
            ...
            <!-- Carousel -->
            <div x-data="carousel" class="j rw" data-aos="zoom-y-out">

              <!-- Testimonials -->
              <div class="j ii ut uj border-gray-200 uy bg-white tp" x-ref="testimonials">

                <!-- Alpine.js template for testimonials: https://github.com/alpinejs/alpine#x-for -->
<!--                <div x-for="(item, index) in items" :key="index">-->
<!--                  <div x-show="active === index" class="ce fz fm lw nu vg" x-transition:enter="hq po ps om td" x-transition:enter-start="hg oa" x-transition:enter-end="hy on" x-transition:leave="hq po pt om _" x-transition:leave-start="hy on" x-transition:leave-end="hg of">-->
<!--                    <div class="_ ta rx tr om or">-->
<!--                      <svg class="_ ta tt rk r_ si ia ft ho" viewBox="0 0 64 64" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">-->
<!--                        <path d="M37.89 58.338c-2.648-5.63-3.572-10.045-2.774-13.249.8-3.203 8.711-13.383 23.737-30.538l2.135.532c-6.552 10.033-10.532 17.87-11.939 23.515-.583 2.34.22 6.158 2.41 11.457l-13.57 8.283zm-26.963-6.56c-2.648-5.63-3.572-10.046-2.773-13.25.799-3.203 8.71-13.382 23.736-30.538l2.136.533c-6.552 10.032-10.532 17.87-11.94 23.515-.583 2.339.22 6.158 2.41 11.456l-13.57 8.283z"></path>-->
<!--                      </svg>-->
<!--                      <img class="j ub" :src="'images/' + item.img" width="96" height="96" :alt="item.alt">-->
<!--                    </div>-->
<!--                    <blockquote class="cr cc nw" x-text="item.quote"></blockquote>-->
<!--                    <cite class="block ch ci cm re" x-text="item.name"></cite>-->
<!--                    <div class="c_">-->
<!--                      <span x-text="item.role"></span> <a class="ht pg" :href="item.link" x-text="item.team"></a>-->
<!--                    </div>-->
<!--                  </div>-->
<!--                </div>-->
              ...
              <!-- Arrows -->
              <div class="_ z ii un uo">
                <button class="j tl si ia ff ii un us bg-white ub uk border-gray-200 shadow-md py om ol mp" @click="active = active === 0 ? items.length - 1 : active - 1; stopAutorotate();">
                  <span class="b">Previous</span>
                  <svg class="ss iv ft text-gray-500" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                    <path d="M6.7 14.7l1.4-1.4L3.8 9H16V7H3.8l4.3-4.3-1.4-1.4L0 8z"></path>
                  </svg>
                </button>
                <button class="j tl si ia ff ii un us bg-white ub uk border-gray-200 shadow-md py om oc md" @click="active = active === items.length - 1 ? 0 : active + 1; stopAutorotate();">
        ...
        <div class="fy gn uq border-gray-200">
          ...
          <ul class="sh tj lk">
            <li x-data="{ expanded: false }">
              <button class="ii un ij ci cc lz f_ uq border-gray-200" @click="expanded = !expanded" :aria-expanded="expanded">
                <svg class="ss iv ft ho s_ rj rq" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                  <rect y="7" width="16" height="2" rx="1" class="om oe hq pr pu" :class="{'!rotate-180': expanded}"></rect>
                  <rect y="7" width="16" height="2" rx="1" class="om oe oh hq pr pu" :class="{'!rotate-180': expanded}"></rect>
                </svg>
                <span>Do I need coding knowledge to use this product?</span>
              </button>
              <div x-ref="item" class="c_ uv pe pt po" :style="expanded ? 'max-height: ' + $refs.item.scrollHeight + 'px; opacity: 1' : 'max-height: 0; opacity: 0'">
                <p class="l_">
            ...
            <li x-data="{ expanded: false }">
              <button class="ii un ij ci cc lz f_ uq border-gray-200" @click="expanded = !expanded" :aria-expanded="expanded">
                ...
                <span>Do you have student or non-profit discounts?</span>
              </button>
              <div x-ref="item" class="c_ uv pe pt po" :style="expanded ? 'max-height: ' + $refs.item.scrollHeight + 'px; opacity: 1' : 'max-height: 0; opacity: 0'">
                <p class="l_">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
            ...
            <li x-data="{ expanded: false }">
              <button class="ii un ij ci cc lz f_ uq border-gray-200" @click="expanded = !expanded" :aria-expanded="expanded">
                ...
                <span>Is there a way to become an Affiliate reseller of this product?</span>
              </button>
              <div x-ref="item" class="c_ uv pe pt po" :style="expanded ? 'max-height: ' + $refs.item.scrollHeight + 'px; opacity: 1' : 'max-height: 0; opacity: 0'">
                <p class="l_">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
            ...
            <li x-data="{ expanded: true }">
              <button class="ii un ij ci cc lz f_ uq border-gray-200" @click="expanded = !expanded" :aria-expanded="expanded">
                ...
                <span>What is the difference between the Free and Paid versions?</span>
              </button>
              <div x-ref="item" class="c_ uv pe pt po" :style="expanded ? 'max-height: ' + $refs.item.scrollHeight + 'px; opacity: 1' : 'max-height: 0; opacity: 0'">
                <p class="l_">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
            ...
            <li x-data="{ expanded: false }">
              <button class="ii un ij ci cc lz f_ uq border-gray-200" @click="expanded = !expanded" :aria-expanded="expanded">
                ...
                <span>How can I change the owner of a workspace?</span>
              </button>
              <div x-ref="item" class="c_ uv pe pt po" :style="expanded ? 'max-height: ' + $refs.item.scrollHeight + 'px; opacity: 1' : 'max-height: 0; opacity: 0'">
                <p class="l_">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
            ...
            <span class="block uq border-gray-200" aria-hidden="true"></span>
          </ul>
    ...
    <section>
      <div class="sc tj fv vs">
        <div class="ls go">
          ...
          <!-- CTA box -->
          <div class="au uy fw fx gr gi hw" data-aos="zoom-y-out">

            <div class="ii oz yo uo un">

              <!-- CTA content -->
              <div class="rn gb gw ce yl">
                <h3 class="h3 cz nk">Ready to get started?</h3>
                <p class="cz ci hb">We have a generous free tier available to get you started right away.</p>
              </div>

              <!-- CTA button -->
              <div>
                <a class="n ht ag aw ak" href="pricing.html#0">Get started for free</a>
              </div>
